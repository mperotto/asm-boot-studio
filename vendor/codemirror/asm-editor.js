var AsmEditorBundle = (() => {
  ...
  // src/codemirror-asm.js
  var codemirror_asm_exports = {};
  __export(codemirror_asm_exports, {
    createAsmEditor: () => createAsmEditor
  });
  ...
  var asmLanguage = StreamLanguage.define({
    name: "nasm",
    startState() {
      return {};
    },
  ...
  var asmHighlight = HighlightStyle.define([
    ...
    { tag: tags.squareBracket, color: "#f0f6fc" },
    { tag: tags.punctuation, color: "#c9d1d9" }
  ]);
  var asmTheme = EditorView.theme({
    "&": {
      height: "100%",
  ...
  function createAsmEditor({ parent, doc: doc2 = "", onChange = () => {
  } }) {
  ...
  return __toCommonJS(codemirror_asm_exports);
})();
